...
public class Order {
    ...
    public void createAnOrder (int idBuyer, ResultSet resultSet, int quantity) throws Exception{
        DatabaseManipulation newOrder = new DatabaseManipulation();
        ...
        if (resultSetGetGeneratedKeyOrders!=null&&generatedOrderId!=-1){
            ...
            newOrder.insertIntoDatabase(query);
            newOrder.updateDatabase("products","quantity",Integer.toString(resultSet.getInt(1)-quantity),"id",resultSet.getString(1));
        }
